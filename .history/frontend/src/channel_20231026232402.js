...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // 为<select>元Add a change event listener for the <select> element素添加change事件监听器
...
function generateChannelList(channelList) {
 ...
 // 展示频道详情信息
  function showChannelDetails(channelInfo,channelId,stat) {
    ...
    privatePara.textContent = `Channel Tpye: ${channelInfo.private ? "Private Channel" : "Public Channel"}`;
