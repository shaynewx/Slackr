...
function generateChannelList(channelList) {
  ...
  const createChannelElement = (channel, joinBtn = false) => {
    ...
    if (joinBtn) {
      ...
      joinButton.addEventListener("click", () => {
        ...
        // TODO: Add additional logic for joining channels
      });
  ...
  function createChannelHearder(channel, stat = false) {
    // When the li tag is clicked, find the channel.id of this channel, and then send a get request to obtain the channel information and store it.
