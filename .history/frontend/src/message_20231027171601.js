...
function addContextMenuListeners() {
  ...
  messageBodies.forEach(function(message) {
    message.addEventListener('contextmenu', function(e) {
      ...
      currentMessageId = e.target.getAttribute("data-id");
      console.log("Clicked message ID:", currentMessageId);
...
function deleteMessage(channelId, messageId) {
  http.deleteReq(`/message/${channelId}/${messageId}`);
}
  ...
  contextOptions.forEach(option => {
      option.addEventListener('click', function(e) {
          ...
          if (this.classList.contains('delete')) {
              ...
              cons
              deleteMessage(currentChannelId, currentMessageId);
