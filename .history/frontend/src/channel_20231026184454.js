 ...
 // 获取频道详情信息
  ...
  function createChannelHearder(channel, stat = false) {
    ...
    channelElementDom.addEventListener("click", () => {
      ...
      channelNameDiv.className = "singlechannel-name";
      ...
      const buttonsInfo = [
          { text: "频道详情", className: "channel-detail-button", action: showChannelDetails },
          { text: "人员列表", className: "channel-users-button" },
          { text: "搜索", className: "channel-search-button" },
          { text: "邀请", className: "channel-invite-button" }
      ];
