  ...
  contextOptions.forEach((option) => {
    option.addEventListener("click", function (e) {
      ...
      if (this.classList.contains("delete")) {
        ...
        // Monitor the submit button of the edit message (you need to first monitor whether the input is empty and whether it is consistent with the current message content)
